  ...
  function search() {
      ...
      setTimeout(() => {
        ...
        <h6 style="text-align: Right;font-size: 11px; font-weight:800;">Verified by: Exam Department</h6>
        <h6 style="text-align: center; font-weight:300; margin-top: 20px; font-size: 9px;  font-family: 'Times New Roman', Times, serif; ">
       <br>  CREDIT EARNED IN THE SEMESTER = &nbsp;&nbsp;&nbsp;&nbsp;<b style="color: black;font-size: 13px; font-weight: 800;">${student.credit.toFixed(2)}</b>
       <br>
          SEMESTER GRADE POINT AVERAGE (SGPA) = &nbsp;&nbsp;<b style="color: black;font-size: 13px; font-weight: 800;">${student.sgpa.toFixed(2)}</b>
        <br>
     
          CUMULATIVE GRADE POINT AVERAGE (CGPA) = &nbsp;&nbsp;<b style="color: black;font-size: 13px; font-weight: 800;">${student.cgpa.toFixed(2)}</b>
       <br>
          EARNED CREDITS (EC) = &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="color: black;font-size: 13px; font-weight: 800;">${student.ec.toFixed(2)}</b>
        </h6>
         </div>
      `);
